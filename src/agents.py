...
##### 1. Market Data Agent #####
def gather_market_data_agent(state: AgentState):
...
def technical_analysis_agent(state: AgentState):
...
def run_trading_system(ticker: str, start_date: str, end_date: str, portfolio: dict, show_decisions: bool = False):
...
trading_graph = StateGraph(AgentState)
